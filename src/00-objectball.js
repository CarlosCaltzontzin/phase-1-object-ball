...
function numPointsScored(){
    ...
    if (gameInfo.home.players[playerName]) {
        return gameInfo.home.players[playerName].points;
    }

    // Check if the player exists in the away team
    if (gameInfo.away.players[playerName]) {
        return gameInfo.away.players[playerName].points;
    }

    // If the player is not found in either team, return an error message or value of your choice
